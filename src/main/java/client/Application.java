...
//    }
    ...
    public static void studentRun(Accounts accounts, String IP) {
        application application = new application();
        application.setUserMailLabel(accounts.getUsername());
        application.getUserIdLabel().setText(accounts.getId()); //set the studentID label on the Application
        application.getIp().setText(IP);
        ...
        applicationController applicationController = new applicationController(application, homePanel, libraryPanel, bookShelfPanel,
                transcriptPanel);
    }
